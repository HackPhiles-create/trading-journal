...
CREATE TABLE "new_preferences" (
    ...
    "newsAlertCurrency" TEXT NOT NULL DEFAULT 'USD',
    "newsAlertHoursBefore" INTEGER NOT NULL DEFAULT 2
);
INSERT INTO "new_preferences" ("autoDetectMistakes", "defaultAccountId", "id", "mistakeMinOccurrences", "mistakeWindowDays", "notifyLowRR", "notifyMonthlyReport", "notifyMultipleLosses", "notifyNewStats", "notifyRepeatedMistake", "notifyWeeklyReport", "preferredMinRR", "soundEnabled", "soundOnClick", "theme", "timezone") SELECT "autoDetectMistakes", "defaultAccountId", "id", "mistakeMinOccurrences", "mistakeWindowDays", "notifyLowRR", "notifyMonthlyReport", "notifyMultipleLosses", "notifyNewStats", "notifyRepeatedMistake", "notifyWeeklyReport", "preferredMinRR", "soundEnabled", "soundOnClick", "theme", "timezone" FROM "preferences";
