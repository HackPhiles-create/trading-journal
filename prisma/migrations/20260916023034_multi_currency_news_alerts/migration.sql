...
INSERT INTO "new_preferences" ("autoDetectMistakes", "defaultAccountId", "id", "mistakeMinOccurrences", "mistakeWindowDays", "newsAlertCurrency", "newsAlertHoursBefore", "newsAlertsEnabled", "notifyLowRR", "notifyMonthlyReport", "notifyMultipleLosses", "notifyNewStats", "notifyRepeatedMistake", "notifyWeeklyReport", "preferredMinRR", "soundEnabled", "soundOnClick", "theme", "timezone") SELECT "autoDetectMistakes", "defaultAccountId", "id", "mistakeMinOccurrences", "mistakeWindowDays", "newsAlertCurrency", "newsAlertHoursBefore", "newsAlertsEnabled", "notifyLowRR", "notifyMonthlyReport", "notifyMultipleLosses", "notifyNewStats", "notifyRepeatedMistake", "notifyWeeklyReport", "preferredMinRR", "soundEnabled", "soundOnClick", "theme", "timezone" FROM "preferences";
